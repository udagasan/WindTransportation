    ...
    Plugin.prototype = {
        ...
        _reset: function() {
            ...
            for (i = this.backgrounds.length - 1; i >= 0; i--) {
                ...
                background.$element.data("stellar-backgroundStartingLeft", null)
        ...
        _repositionElements: function() {
            ...
            for (i = this.particles.length - 1; i >= 0; i--) {
                ...
                if (this.options.hideDistantElements) {
                    isVisibleHorizontal = !this.options.horizontalScrolling ||
                    ...
                    isVisibleVertical = !this.options.verticalScrolling ||
